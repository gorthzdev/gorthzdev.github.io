...
export function easyMobs(dados) {
  switch (dados) {
    case 1: return new EnemyMobs("Zombie", 200, 200, 30, 5, 10, 5,
       [weapons.c_oxidado, weapons.c_oxidado, weapons.oz], 'img-characters/zombie_iddle.gif','css/UI/zombie_special.png');
       //
    ...
    case 3: return new EnemyMobs("Liquen Viviente", 250, 250, 40, 5, 15, 10,
       [weapons.mazo_liqueneano, weapons.oz , weapons.mazo_liqueneano], 'img-characters/liken.gif','css/UI/zombie_special.png');
...
export function middleMobs(dados) {
  switch (dados) {
    ...
    case 2: return new EnemyMobs("Esqueleto Brutal", 400, 400, 50, 15, 30, 10,
...
export function crowMane(){
  return new EnemyMobs("Dios Maldito CrowMane", 1000, 1000, 30, 20, 100, 10, 
    [weapons.voidness, weapons.voidness, weapons.voidness], 'img-characters/crowmane.gif','css/UI/voidmane_atk.gif');
}
